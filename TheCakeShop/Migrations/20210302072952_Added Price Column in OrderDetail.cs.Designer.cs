...
namespace TheCakeShop.Migrations
{
    ...
    [Migration("20210302072952_Added Price Column in OrderDetail.cs")]
    partial class AddedPriceColumninOrderDetailcs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheCakeShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("TheCakeShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("TheCakeShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TheCakeShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheCakeShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("TheCakeShop.Models.OrderDetail", b =>
                {
                    b.HasOne("TheCakeShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheCakeShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TheCakeShop.Models.Pie", b =>
                {
                    b.HasOne("TheCakeShop.Models.Category", "Category")
                        .WithMany("Pies")
